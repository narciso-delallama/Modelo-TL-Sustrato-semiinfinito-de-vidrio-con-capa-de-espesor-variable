...
model_NN = load_model("modelo_nn_semi_nuevo2.h5", compile=False)
scaler_X_NN = joblib.load("scaler_X_nn_semi_nuevo2.pkl")
scaler_y_NN = joblib.load("scaler_y_nn_semi_nuevo2.pkl")


#Cargar espectro experimental
df = pd.read_excel("Narciso_Exp3.xlsx")
...
df_fit2=calcular_psi_delta_semi(289.5278,  2.5699370 , 0.8675791, 2.269181, 1.790976, 45.7162, 70, E_values=energias_interp)
...
fig, axs = plt.subplots(2, 2, figsize=(12, 7))  # 2 filas, 2 columnas
